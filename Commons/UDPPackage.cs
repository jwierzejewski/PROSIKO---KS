...
namespace Commons
{
    public static class UDPPackage
    {
        ...
        public static string RecievePackages(this UdpClient udpClient, ref IPEndPoint remoteIpEndPoint)
        {
            ...
            count = processPackage(data, priorityQueue);
            i++;
            ...
            {
                data = udpClient.Receive(ref remoteIpEndPoint);
                processPackage(data, priorityQueue);
                i++;
            }
        ...
        private static int processPackage(byte[] data, PriorityQueue<string, int> priorityQueue)
        {
            ...
            priorityQueue.Enqueue(message, number);
